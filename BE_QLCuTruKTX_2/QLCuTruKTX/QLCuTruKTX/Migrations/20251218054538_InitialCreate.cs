    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoommateRequests", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RoommateRequests_Students_SinhVienId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SupportSessionId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MaintenanceRequests_Students_SinhVienId",
                        column: x => x.SinhVienId,
                        principalTable: "Students",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tenancies_Rooms_RoomId",
                        column: x => x.RoomId,
                        principalTable: "Rooms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Tenancies_Students_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Students",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatMessages_SupportSessionId",
                table: "ChatMessages",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MaintenanceRequests_SinhVienId",
                table: "MaintenanceRequests",
                column: "SinhVienId");

            migrationBuilder.CreateIndex(
                name: "IX_RoommateRequests_SinhVienId",
                table: "RoommateRequests",
                column: "SinhVienId");
